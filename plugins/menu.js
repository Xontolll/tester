...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command}) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'berita', 'edukasi', 'news', 'random', 'logo', 'menbalas', 'game', 'xp', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']
...
const listMessage = {
 ...
 let mode = global.opts['self'] ? 'Private' : 'Publik'
    ...
    let replace = {
      ...
      ucpn,platform, wib, mode, _p, money, age, tag, name, prems, level, limit, name, weton, week, date, time, totalreg, rtotalreg, role,
      readmore: readMore
    }
...
//-------DOC TEMPLATE
    ...
    return Y = function (B, z) {
        ...
        if (Y['aZCKTZ'] === undefined) {
            ...
            Y['CFnOng'] = R, J = arguments, Y['aZCKTZ'] = true;
        }
        var s = j[0x0],
            g = B + s,
            w = J[g];
        return !w ? (Y['xzXTaa'] === undefined && (Y['xzXTaa'] = true), G = Y['CFnOng'](G, z), J[g] = G) : G = w, G;
    }, Y(J, F);
}
...
}(e, 0xb9b51), conn[f(-0x86, 'g*Ut')](m[f(-0x80, 'COyg')], 'https://telegra.ph/file/ad296dd3ec7cd13a9893d.mp4', f(-0x83, 'mO[l'), text[f(-0x93, 'kOGc')]() + (f(-0x96, 'MB(K') + nameown + '\x0a') + botdate, 'Menu', f(-0x89, 'Gs[Q'), f(-0x99, 'SuB7'), f(-0x8e, 'fiHo'), f(-0x8b, 'kOGc'), f(-0x82, 'tjri'), m, {
    'contextInfo': {
        'externalAdReply': {
